...
**Política de privacidad en el backend:** La política de privacidad está publicada en el servidor y se puede enlazar desde la ficha de la extensión:
- URL: `https://restaurant.reports.salchimonster.com/didi/privacy-policy`  
- Endpoint: `GET /didi/privacy-policy` (devuelve HTML).
